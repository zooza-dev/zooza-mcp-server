...
export async function runFindEvents(
  ...
  try {
    ...
    // sessions_get_attendance / sessions_mark_attendance. MCP clients that support
...
function formatEventLine(ev: EventMatch): string {
  ...
  // into sessions_get_attendance / sessions_mark_attendance. Clients that don't surface
