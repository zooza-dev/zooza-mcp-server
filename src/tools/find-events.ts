...
export async function runFindEvents(
  ...
  try {
    ...
    // get_attendance / mark_attendance. MCP clients that support
...
function formatEventLine(ev: EventMatch): string {
  ...
  // into get_attendance / mark_attendance. Clients that don't surface
